...
export default function DashboardSummaryCards() {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 mb-6">
      <SummaryCard title="Total vendido hoy" value={"$ " + totalAmountToday} icon={<span>💰</span>} />
      <SummaryCard title="Ventas realizadas" value={totalSalesToday} icon={<span>🧾</span>} />
      <SummaryCard title="Promedio por venta" value={"$ " + averageSale} icon={<span>📊</span>} />
      {topProduct
